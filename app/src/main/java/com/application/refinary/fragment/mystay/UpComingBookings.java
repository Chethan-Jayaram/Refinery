...
public class UpComingBookings extends Fragment  {
    ...
    private List<Upcoming> bookingHistory;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_up_coming_bookings, container, false);
        try {
    ...
    private void setadapter() {
        ...
        UpComingBookingAdapter adapter = new UpComingBookingAdapter(mContext,(List<Upcoming>) bookingHistory, flag->{
