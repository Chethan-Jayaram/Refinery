...
public class DiningWebView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dining_menu_list, container, false);
        try {
            ...
            if (args != null) {
                web_view.loadUrl(args.getString("url"));
                toolbar_title.setText(args.getString("title"));
            } else {
                GlobalClass.ShowAlet(mContext, "Alert", "Something went wrong please try again");
            }
